...
# get bam files
filenames <- file.path("bams", c("HU_rep1.bam", "HU_rep2.bam", "NT_rep1.bam", "NT_rep2.bam", "wgEncodeLicrRnaSeqBatCellPapMAdult24wksC57bl6AlnRep1.bam", "wgEncodeLicrRnaSeqBatCellPapMAdult24wksC57bl6AlnRep2.bam", "wgEncodeLicrRnaSeqBmdmCellPapFAdult8wksC57bl6AlnRep1.bam", "wgEncodeLicrRnaSeqBmdmCellPapFAdult8wksC57bl6AlnRep2.bam", "wgEncodeLicrRnaSeqCortexCellPapMAdult8wksC57bl6AlnRep1.bam", "wgEncodeLicrRnaSeqCortexCellPapMAdult8wksC57bl6AlnRep2.bam", "wgEncodeLicrRnaSeqMefCellPapMAdult8wksC57bl6AlnRep1.bam", "wgEncodeLicrRnaSeqMefCellPapMAdult8wksC57bl6AlnRep2.bam"))

# get csv metadata file
csvfile <- file.path(".", "RNAseq_metadata.csv")
...
# create DESeq object testing cellment
dds <- DESeqDataSet(se, design = ~ cell)
...
df <- as.data.frame(colData(rld)[ "cell" ])
